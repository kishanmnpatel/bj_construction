        ...
        {{-- <table cellpadding="0" cellspacing="0"
            ...
            <tbody>
                ...
                <tr>
                        ...
                        <td>{{$invoice->wasteWaterFullJobInvoices[1]['unit_price']}}</td>
                        <td>{{$invoice->wasteWaterFullJobInvoices[1]['total']}}</td>
                    </tr>
                    <tr>
                        <td>02</td>
                        ...
                        <td>{{$invoice->wasteWaterFullJobInvoices[2]['unit_price']}}</td>
                        <td>{{$invoice->wasteWaterFullJobInvoices[2]['total']}}</td>
                    </tr>
                    <tr>
                        <td>03</td>
                        ...
                        <td>{{$invoice->wasteWaterFullJobInvoices[3]['unit_price']}}</td>
                        <td>{{$invoice->wasteWaterFullJobInvoices[3]['total']}}</td>
                    </tr>
                    <tr>
                        <td>04</td>
                        ...
                        <td>{{$invoice->wasteWaterFullJobInvoices[4]['unit_price']}}</td>
                        <td>{{$invoice->wasteWaterFullJobInvoices[4]['total']}}</td>
                    </tr>
                    <tr>
                        <td>05</td>
                        ...
                        <td>{{$invoice->wasteWaterFullJobInvoices[5]['unit_price']}}</td>
                        <td>{{$invoice->wasteWaterFullJobInvoices[5]['total']}}</td>
                    </tr>
                    <tr>
                        <td>06</td>
                        ...
                        <td>{{$invoice->wasteWaterFullJobInvoices[6]['unit_price']}}</td>
                        <td>{{$invoice->wasteWaterFullJobInvoices[6]['total']}}</td>
                    </tr>
                    <tr>
                        <td>07</td>
                        ...
                        <td>{{$invoice->wasteWaterFullJobInvoices[7]['unit_price']}}</td>
                        <td>{{$invoice->wasteWaterFullJobInvoices[7]['total']}}</td>
                    </tr>
                    <tr>
                        <td>08</td>
                        ...
                        <td>{{$invoice->wasteWaterFullJobInvoices[8]['unit_price']}}</td>
                        <td>{{$invoice->wasteWaterFullJobInvoices[8]['total']}}</td>
                    </tr>
                    <tr>
                        <td>09</td>
                        ...
                        <td>{{$invoice->wasteWaterFullJobInvoices[9]['unit_price']}}</td>
                        <td>{{$invoice->wasteWaterFullJobInvoices[9]['total']}}</td>
                    </tr>
                    <tr>
                        <td>10</td>
                        <td><p style="margin-top:0pt; margin-bottom:0pt; text-align:justify; font-size:10pt;"><span
                        ...
                        <td>{{$invoice->wasteWaterFullJobInvoices[10]['unit_price']}}</td>
                        <td>{{$invoice->wasteWaterFullJobInvoices[10]['total']}}</td>
                    </tr>
                    <tr>
                        <td>11</td>
                        ...
                        <td>{{$invoice->wasteWaterFullJobInvoices[11]['unit_price']}}</td>
                        <td>{{$invoice->wasteWaterFullJobInvoices[11]['total']}}</td>
                    </tr>
                    <tr>
                        <td>12</td>
                        ...
                        <td>{{$invoice->wasteWaterFullJobInvoices[12]['extra_item'] == '0' || $invoice->wasteWaterFullJobInvoices[12]['extra_item']== '' || $invoice->wasteWaterFullJobInvoices[12]['extra_item'] == 'null' ? '' : $invoice->wasteWaterFullJobInvoices[12]['unit_price']}}</td>
                        <td>{{$invoice->wasteWaterFullJobInvoices[12]['extra_item'] == '0' || $invoice->wasteWaterFullJobInvoices[12]['extra_item']== '' || $invoice->wasteWaterFullJobInvoices[12]['extra_item'] == 'null' ? '' : $invoice->wasteWaterFullJobInvoices[12]['total']}}</td>
                    </tr>
                    <tr>
                        <td>13</td>
                        ...
                        <td>{{$invoice->wasteWaterFullJobInvoices[13]['extra_item'] == '0' || $invoice->wasteWaterFullJobInvoices[13]['extra_item']== '' || $invoice->wasteWaterFullJobInvoices[13]['extra_item'] == 'null' ? '' : $invoice->wasteWaterFullJobInvoices[13]['unit_price']}}</td>
                        <td>{{$invoice->wasteWaterFullJobInvoices[13]['extra_item'] == '0' || $invoice->wasteWaterFullJobInvoices[13]['extra_item']== '' || $invoice->wasteWaterFullJobInvoices[13]['extra_item'] == 'null' ? '' : $invoice->wasteWaterFullJobInvoices[13]['total']}}</td>
                    </tr>
                    <tr>
                        <td></td>
