        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('mobile') is-invalid @enderror" id="contact_no" placeholder="Mobile" name="mobile" value="{{auth()->user()->mobile}}" autofocus disabled>
                    <input type="hidden" name="user_id" id="user_id" value="{{auth()->user()->id}}"><br>
                    {{-- <button class="btn btn-primary btn-sm" type="button" onclick="getUser();">Get</button> --}}
                </div>
                <div class="form-group">
                    <label>Customer Name</label>
                    <input type="text" class="form-control @error('name') is-invalid @enderror" id="user_name" placeholder="Customer Name" name="name" value="{{auth()->user()->name}}" disabled >
                </div>
                <div class="form-group">
                    <label>Address</label>
                    <input type="text" class="form-control @error('address') is-invalid @enderror" id="user_address" placeholder="Address" value="{{auth()->user()->address}}" name="address" autocomplete="false" disabled>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
